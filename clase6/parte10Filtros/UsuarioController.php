...
class UsuarioController
{
    ...
    public function ModificarClaveUsuario($ClaveNueva)
    {
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
        $consulta = $objetoAccesoDato->RetornarConsulta("
				update usuario 	set		
    ...
    public static function TraerTodoLosUsuarios($orden)
    {
        
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
        
        $consulta = $objetoAccesoDato->RetornarConsulta("select * from usuario order by apellido $orden ,nombre ");
        $consulta->execute();
    ...
    public static function TraerUnUsuarioPorMail($mail)
    {
        ...
        $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
        $consulta = $objetoAccesoDato->RetornarConsulta("select id as ID, clave from usuario where mail = '$mail'");
        $consulta->execute();
        $UsuarioBuscado = $consulta->fetchObject('usuarioController');
        return $UsuarioBuscado;
    }
    ...
    public static function TraerUnUsuarioMail($mail)
    {
        ...
        $consulta->execute(array(':mail' => $mail));
